...
let ppl = document.querySelector("._popup-link");
let ppfad = document.querySelector(".footer__address");
let ppb = document.querySelector(".popup__body");
...
document.onclick = function(e){
	if (!iconMenu.contains(e.target) && !menuBody.contains(e.target) && !ppl.contains(e.target) && !ppfad.contains(e.target) && !ppb.contains(e.target)) {
...
//RANGE
const priceSlider = document.querySelector('.filters__range-line');
if (priceSlider) {
...
function initMap() {
	const pos = { lat: 59.938667, lng: 30.323073};
